...
@interface Souza_Denise_Project4Object : KrollCoverageObject {
#else
@interface Souza_Denise_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Souza_Denise_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Souza_Denise_Project4Object *_souza_denise_project4;
    KrollObject* console;
	BOOL shutdown;
