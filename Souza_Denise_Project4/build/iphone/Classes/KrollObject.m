...
//@interface Souza_Denise_Project4Object : NSObject
//@end

@interface Souza_Denise_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Souza_Denise_Project4Object class]])
		{
			for (NSString *key in [[(Souza_Denise_Project4Object*)o modules] allKeys])
			{
