 ...
 * to send analytic data that can be viewed on the Souza_Denise_Project4 Dashboard.
 *
 * For information on getting started with Souza_Denise_Project4 Platform Services,
