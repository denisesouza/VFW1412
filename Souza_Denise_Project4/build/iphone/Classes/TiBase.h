...
// in simulator we redefine to format for Souza_Denise_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.souza_denise_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.souza_denise_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISouza_Denise_Project4NativeItemNone = -1, 
	UISouza_Denise_Project4NativeItemSpinner = -2,
	UISouza_Denise_Project4NativeItemProgressBar = -3,
	
	UISouza_Denise_Project4NativeItemSlider = -4,
	UISouza_Denise_Project4NativeItemSwitch = -5,
	UISouza_Denise_Project4NativeItemMultiButton = -6,
	UISouza_Denise_Project4NativeItemSegmented = -7,
	
	UISouza_Denise_Project4NativeItemTextView = -8,
	UISouza_Denise_Project4NativeItemTextField = -9,
	UISouza_Denise_Project4NativeItemSearchBar = -10,
	
	UISouza_Denise_Project4NativeItemPicker = -11,
	UISouza_Denise_Project4NativeItemDatePicker = -12,
	
	UISouza_Denise_Project4NativeItemInfoLight = -13,
	UISouza_Denise_Project4NativeItemInfoDark = -14,
	
	UISouza_Denise_Project4NativeItemDisclosure = -15,
	
	UISouza_Denise_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Souza_Denise_Project4 instances of
