...
//@interface Souza_Denise_Project3Object : NSObject
//@end

@interface Souza_Denise_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Souza_Denise_Project3Object class]])
		{
			for (NSString *key in [[(Souza_Denise_Project3Object*)o modules] allKeys])
			{
