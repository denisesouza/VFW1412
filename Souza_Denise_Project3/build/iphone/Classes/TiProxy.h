...
//Rare exceptions to indicate a bug in the _souza_denise_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Souza_Denise_Project3 proxies.
 */
