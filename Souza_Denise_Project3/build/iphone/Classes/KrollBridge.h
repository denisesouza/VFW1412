...
@interface Souza_Denise_Project3Object : KrollCoverageObject {
#else
@interface Souza_Denise_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Souza_Denise_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Souza_Denise_Project3Object *_souza_denise_project3;
    KrollObject* console;
	BOOL shutdown;
