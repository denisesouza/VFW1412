...
/**
 The base class for all Souza_Denise_Project3 modules
 */
...
/**
 Souza_Denise_Project3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Souza_Denise_Project3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Souza_Denise_Project3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Souza_Denise_Project3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Souza_Denise_Project3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
