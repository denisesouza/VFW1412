...
// in simulator we redefine to format for Souza_Denise_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.souza_denise_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.souza_denise_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISouza_Denise_Project3NativeItemNone = -1, 
	UISouza_Denise_Project3NativeItemSpinner = -2,
	UISouza_Denise_Project3NativeItemProgressBar = -3,
	
	UISouza_Denise_Project3NativeItemSlider = -4,
	UISouza_Denise_Project3NativeItemSwitch = -5,
	UISouza_Denise_Project3NativeItemMultiButton = -6,
	UISouza_Denise_Project3NativeItemSegmented = -7,
	
	UISouza_Denise_Project3NativeItemTextView = -8,
	UISouza_Denise_Project3NativeItemTextField = -9,
	UISouza_Denise_Project3NativeItemSearchBar = -10,
	
	UISouza_Denise_Project3NativeItemPicker = -11,
	UISouza_Denise_Project3NativeItemDatePicker = -12,
	
	UISouza_Denise_Project3NativeItemInfoLight = -13,
	UISouza_Denise_Project3NativeItemInfoDark = -14,
	
	UISouza_Denise_Project3NativeItemDisclosure = -15,
	
	UISouza_Denise_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Souza_Denise_Project3 instances of
