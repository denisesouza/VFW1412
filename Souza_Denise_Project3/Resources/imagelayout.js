...
var itemCount = 30;  //number of thumbnail images
var rowCount = 4;
var margin = 10;
var spacing = 10;
var numberOfSpace = (rowCount + 1) * spacing;    //math for spacing of thumbnails
...
var border = Ti.UI.createView({
	backgroundColor: "#fff",
	top: galleryTitle.top + galleryTitle.height,  //20 + 50
	height: 1,
});
...
var container = Ti.UI.createScrollView({
	width: pWidth,
	contentWidth: pWidth,
	height: pHeight - galleryTitle.top - galleryTitle.height - closeButton.height,
...
//Use of event propagation for the images
