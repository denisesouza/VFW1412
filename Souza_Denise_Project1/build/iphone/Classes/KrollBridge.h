...
@interface Souza_Denise_Project1Object : KrollCoverageObject {
#else
@interface Souza_Denise_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Souza_Denise_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Souza_Denise_Project1Object *_souza_denise_project1;
    KrollObject* console;
	BOOL shutdown;
