...
// in simulator we redefine to format for Souza_Denise_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.souza_denise_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.souza_denise_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISouza_Denise_Project1NativeItemNone = -1, 
	UISouza_Denise_Project1NativeItemSpinner = -2,
	UISouza_Denise_Project1NativeItemProgressBar = -3,
	
	UISouza_Denise_Project1NativeItemSlider = -4,
	UISouza_Denise_Project1NativeItemSwitch = -5,
	UISouza_Denise_Project1NativeItemMultiButton = -6,
	UISouza_Denise_Project1NativeItemSegmented = -7,
	
	UISouza_Denise_Project1NativeItemTextView = -8,
	UISouza_Denise_Project1NativeItemTextField = -9,
	UISouza_Denise_Project1NativeItemSearchBar = -10,
	
	UISouza_Denise_Project1NativeItemPicker = -11,
	UISouza_Denise_Project1NativeItemDatePicker = -12,
	
	UISouza_Denise_Project1NativeItemInfoLight = -13,
	UISouza_Denise_Project1NativeItemInfoDark = -14,
	
	UISouza_Denise_Project1NativeItemDisclosure = -15,
	
	UISouza_Denise_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Souza_Denise_Project1 instances of
