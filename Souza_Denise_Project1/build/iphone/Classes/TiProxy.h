...
//Rare exceptions to indicate a bug in the _souza_denise_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Souza_Denise_Project1 proxies.
 */
