...
//@interface Souza_Denise_Project1Object : NSObject
//@end

@interface Souza_Denise_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Souza_Denise_Project1Object class]])
		{
			for (NSString *key in [[(Souza_Denise_Project1Object*)o modules] allKeys])
			{
