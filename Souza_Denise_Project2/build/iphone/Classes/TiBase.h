...
// in simulator we redefine to format for Souza_Denise_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.souza_denise_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.souza_denise_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISouza_Denise_Project2NativeItemNone = -1, 
	UISouza_Denise_Project2NativeItemSpinner = -2,
	UISouza_Denise_Project2NativeItemProgressBar = -3,
	
	UISouza_Denise_Project2NativeItemSlider = -4,
	UISouza_Denise_Project2NativeItemSwitch = -5,
	UISouza_Denise_Project2NativeItemMultiButton = -6,
	UISouza_Denise_Project2NativeItemSegmented = -7,
	
	UISouza_Denise_Project2NativeItemTextView = -8,
	UISouza_Denise_Project2NativeItemTextField = -9,
	UISouza_Denise_Project2NativeItemSearchBar = -10,
	
	UISouza_Denise_Project2NativeItemPicker = -11,
	UISouza_Denise_Project2NativeItemDatePicker = -12,
	
	UISouza_Denise_Project2NativeItemInfoLight = -13,
	UISouza_Denise_Project2NativeItemInfoDark = -14,
	
	UISouza_Denise_Project2NativeItemDisclosure = -15,
	
	UISouza_Denise_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Souza_Denise_Project2 instances of
