 ...
 * to send analytic data that can be viewed on the Souza_Denise_Project2 Dashboard.
 *
 * For information on getting started with Souza_Denise_Project2 Platform Services,
