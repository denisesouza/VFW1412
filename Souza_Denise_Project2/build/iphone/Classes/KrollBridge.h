...
@interface Souza_Denise_Project2Object : KrollCoverageObject {
#else
@interface Souza_Denise_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Souza_Denise_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Souza_Denise_Project2Object *_souza_denise_project2;
    KrollObject* console;
	BOOL shutdown;
