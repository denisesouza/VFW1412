...
//@interface Souza_Denise_Project2Object : NSObject
//@end

@interface Souza_Denise_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Souza_Denise_Project2Object class]])
		{
			for (NSString *key in [[(Souza_Denise_Project2Object*)o modules] allKeys])
			{
