...
/**
 Base class for all TestProject views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TestProject view hierarchy (such as wrapped iOS UIViews) was touched.
