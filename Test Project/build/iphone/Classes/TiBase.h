...
// in simulator we redefine to format for TestProject Developer console
...
{\
	NSString * exceptionName = [@"org.testproject." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.testproject";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITestProjectNativeItemNone = -1, 
	UITestProjectNativeItemSpinner = -2,
	UITestProjectNativeItemProgressBar = -3,
	
	UITestProjectNativeItemSlider = -4,
	UITestProjectNativeItemSwitch = -5,
	UITestProjectNativeItemMultiButton = -6,
	UITestProjectNativeItemSegmented = -7,
	
	UITestProjectNativeItemTextView = -8,
	UITestProjectNativeItemTextField = -9,
	UITestProjectNativeItemSearchBar = -10,
	
	UITestProjectNativeItemPicker = -11,
	UITestProjectNativeItemDatePicker = -12,
	
	UITestProjectNativeItemInfoLight = -13,
	UITestProjectNativeItemInfoDark = -14,
	
	UITestProjectNativeItemDisclosure = -15,
	
	UITestProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TestProject instances of
