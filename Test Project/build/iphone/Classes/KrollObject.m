...
//@interface TestProjectObject : NSObject
//@end

@interface TestProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TestProjectObject class]])
		{
			for (NSString *key in [[(TestProjectObject*)o modules] allKeys])
			{
