...
@interface TestProjectObject : KrollCoverageObject {
#else
@interface TestProjectObject : KrollObject {
#endif
@private
...
extern NSString * TestProject$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TestProjectObject *_testproject;
    KrollObject* console;
	BOOL shutdown;
