...
//Rare exceptions to indicate a bug in the _firstproject code (Eg, function that a subclass should have implemented)
...
/**
 The base class for FirstProject proxies.
 */
