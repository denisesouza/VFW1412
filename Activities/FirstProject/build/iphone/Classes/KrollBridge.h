...
@interface FirstProjectObject : KrollCoverageObject {
#else
@interface FirstProjectObject : KrollObject {
#endif
@private
...
extern NSString * FirstProject$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FirstProjectObject *_firstproject;
    KrollObject* console;
	BOOL shutdown;
