...
// in simulator we redefine to format for FirstProject Developer console
...
{\
	NSString * exceptionName = [@"org.firstproject." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.firstproject";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFirstProjectNativeItemNone = -1, 
	UIFirstProjectNativeItemSpinner = -2,
	UIFirstProjectNativeItemProgressBar = -3,
	
	UIFirstProjectNativeItemSlider = -4,
	UIFirstProjectNativeItemSwitch = -5,
	UIFirstProjectNativeItemMultiButton = -6,
	UIFirstProjectNativeItemSegmented = -7,
	
	UIFirstProjectNativeItemTextView = -8,
	UIFirstProjectNativeItemTextField = -9,
	UIFirstProjectNativeItemSearchBar = -10,
	
	UIFirstProjectNativeItemPicker = -11,
	UIFirstProjectNativeItemDatePicker = -12,
	
	UIFirstProjectNativeItemInfoLight = -13,
	UIFirstProjectNativeItemInfoDark = -14,
	
	UIFirstProjectNativeItemDisclosure = -15,
	
	UIFirstProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FirstProject instances of
