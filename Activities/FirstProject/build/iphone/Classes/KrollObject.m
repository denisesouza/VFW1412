...
//@interface FirstProjectObject : NSObject
//@end

@interface FirstProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FirstProjectObject class]])
		{
			for (NSString *key in [[(FirstProjectObject*)o modules] allKeys])
			{
