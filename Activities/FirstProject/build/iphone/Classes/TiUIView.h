...
/**
 Base class for all FirstProject views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FirstProject view hierarchy (such as wrapped iOS UIViews) was touched.
